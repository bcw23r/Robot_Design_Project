...
OBS_RETURN_GAIN  = 0.70          # 복귀 조향 계수 (회피 방향의 반대로 이 비율만큼)

HUG_DIST         = 250.0         # 이 거리(mm) 이하면 벽 붙어서 주행 모드 진입
HUG_TARGET_DIST  = 150.0         # 유지할 목표 측면 거리 (mm)
HUG_KP           = 0.005         # 거리 오차 → 조향 비례 계수 (mm당)
